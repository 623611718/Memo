...
public class CommomDialog extends Dialog implements View.OnClickListener{
    ...
    private void initView(){
        ...
        submitTxt.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {

                if (hasFocus) {
                    submitTxt.setBackgroundResource(R.drawable.shape_button_focus);
                } else {
                    submitTxt.setBackgroundResource(R.drawable.shape_button);
                }
            }
        });
